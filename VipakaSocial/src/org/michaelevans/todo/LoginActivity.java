...
public class LoginActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Parse.initialize(this, "2FAVfgoGGuNBT8TQiVxBnIkwEpiUGHL3vJeKZRGR", "1bNlCtmoSMnKTw8jEX3UV5eiMtVVYUeIsqnkX1he");
		PushService.setDefaultPushCallback(this, LoginActivity.class);
		ParseInstallation.getCurrentInstallation().saveInBackground();

		mNameField = (EditText) findViewById(R.id.login_username);
	...
	public void signIn(final View v){
		v.setEnabled(false);
		ParseUser.logInInBackground(mNameField.getText().toString(), mPasswordField.getText().toString(), new LogInCallback() {
			@Override
